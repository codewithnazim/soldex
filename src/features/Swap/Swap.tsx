      ...
      <div>
        ...
        >
          <GridItem
            ref={swapPanelRef}
            // gridArea="panel"
            width={['100%', '100%']}  // 100% width on mobile, 50% on larger screens
          >
            <HStack alignSelf="flex-end" style={{ marginBottom: '10px', padding: "1px 20px" }}>
              <h5 style={{ fontSize: '30px' }}>Swap</h5>
